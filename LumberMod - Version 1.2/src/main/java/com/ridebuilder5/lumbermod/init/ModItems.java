...
public class ModItems {
	...
	//Items - Softwood: Part 2
	public static final Item COAST_REDWOOD_STICK = new ItemBase("coast_redwood_stick");
	public static final Item JAPANESE_YEW_STICK = new ItemBase("japanese_yew_stick");
	public static final Item LARCH_STICK = new ItemBase("larch_stick");
	public static final Item NOOTKA_CYPRESS_STICK = new ItemBase("nootka_cypress_stick");
	public static final Item PINE_STICK = new ItemBase("pine_stick");
	public static final Item RED_CEDAR_STICK = new ItemBase("red_cedar_stick");
	public static final Item RIMU_STICK = new ItemBase("rimu_stick");
	public static final Item SUGI_STICK = new ItemBase("sugi_stick");
	public static final Item WHITE_CEDAR_STICK = new ItemBase("white_cedar_stick");
